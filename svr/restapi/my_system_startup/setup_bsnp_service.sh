...
sudo ln -sf /var/www/html/wdaws/bb/svr/restapi/my_system_startup/bsnp.service /etc/systemd/system/bsnp.service

#sudo cp ./bsnp_a_node.service /etc/systemd/system/bsnp_a_node.service

sudo chmod 777 /etc/systemd/system/bsnp.service
