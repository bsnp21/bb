...
var part1 = ["gS", "", "zkTP", "", "gFN", "", "nz9v5wGF", "", "5eN"]

//gSzkTPgFNnz9v5wGF5eN


var BaseEmail2Github = function (email) {
    this.m_email = email
    this.m_repos = email.replace(/[\@|\.]/g, "_")

    //https://${userproj.username}:${passcode}@${userproj.hostname}/${userproj.username}/${userproj.projname}.git`
    var sponsor_git_usr = "bsnp21"
    var sponsor_git_pat = part1.join("")
    this.m_giturl = `https://${sponsor_git_usr}:${sponsor_git_pat}@github.com/${sponsor_git_usr}/${this.m_repos}.git`
    this.m_emailer_repo = `https://github.com/${sponsor_git_usr}/${this.m_repos}.git`
    //https://github.com/bsnp21/install.git
}
BaseEmail2Github.prototype.gh_create_repos = function () {

}
BaseEmail2Github.prototype.Set_Gitusr = function (repopath, passcode) {
...
BaseEmail2Github.prototype._interpret_repo_url_str = function (proj_url) {
...
BaseEmail2Github.prototype._interpret_repo_url_github = function (proj_url) {
    if (!proj_url) return null
...
BaseEmail2Github.prototype._interpret_repo_url_bitbucket = function (proj_url) {
    if (!proj_url) return null
...
BaseEmail2Github.prototype._interpret_git_config_Usr_Pwd_Url = function () {
...
BaseEmail2Github.prototype._prepare_proj_dirs = function () {
    if (!this.m_gitinf) return null
    //const WorkingBaseNodeName = "ddgt"
    ...
    projDirs.user_dir = `${absRootPath}${WorkingBaseNodeName}/${NodeUsrs}`
    projDirs.git_root = `${absRootPath}${WorkingBaseNodeName}/${NodeUsrs}/${userproj.projname}`
    projDirs.acct_dir = `${absRootPath}${WorkingBaseNodeName}/${NodeUsrs}/${userproj.projname}/account`
    projDirs.dest_myo = `${absRootPath}${WorkingBaseNodeName}/${NodeUsrs}/${userproj.projname}/account/myoj`
    projDirs.dest_dat = `${absRootPath}${WorkingBaseNodeName}/${NodeUsrs}/${userproj.projname}/account/dat`
...
BaseEmail2Github.prototype.get_DocCode_Fname = function (DocCode) {
...
BaseEmail2Github.prototype.get_pfxname = function (DocCode) {
    var inp = this.m_inp
...
BaseEmail2Github.prototype.get_userpathfile_from_tempathfile = function (tmpathfile) {
...
BaseEmail2Github.prototype.Check_proj_state = function (cbf) {
...
BaseEmail2Github.prototype.run_makingup_missing_files = function (bCpy) {
...
BaseEmail2Github.prototype.Deploy_proj = function () {
...
BaseEmail2Github.prototype.Destroy_proj = function () {
...
BaseEmail2Github.prototype.cp_template_to_git = function () {
...
BaseEmail2Github.prototype.chmod_R_777_acct = function (spath) {
    // mode : "777" 
    var inp = { out: {} };//this.m_inp
...
BaseEmail2Github.prototype.chmod_R_ = function (mode, dir) {
    // mode : "777" 
    var inp = { out: {} }//this.m_inp
...
BaseEmail2Github.prototype.load_git_config = function () {
...
BaseEmail2Github.prototype.Load_back_userData = function (par) {
    //var inp = this.m_inp
...
BaseEmail2Github.prototype.Save_userData_frm_client = function (par) {
    //var inp = this.m_inp
...
BaseEmail2Github.prototype.git_config_allow_push = function (bAllowPush) {
    { /****.git/config
        [core]
...
BaseEmail2Github.prototype.git_clone = function () {
    //var password = "lll" //dev mac
    var _THIS = this
    var inp = { out: {} };//this.m_inp
...
BaseEmail2Github.prototype.git_status = async function (_sb) {
    var inp = { out: {} }
...
BaseEmail2Github.prototype.git_add_commit_push_Sync = function (msg) {
    var _THIS = this
    var inp = {};//this.m_inp
    var gitdir = this.get_usr_git_dir()
    if (!fs.existsSync(gitdir)) {
...
BaseEmail2Github.prototype.git_pull = function (cbf) {
...
BaseEmail2Github.prototype.git_push = async function () {
    this.git_config_allow_push(true)
...
BaseEmail2Github.prototype.git_push_test = function () {
...
BaseEmail2Github.prototype.execSync_cmd_git = function (gitcmd) {
    var _THIS = this
...
module.exports = {
    BaseEmail2Github: BaseEmail2Github,
