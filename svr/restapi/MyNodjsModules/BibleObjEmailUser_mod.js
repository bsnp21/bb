...
NCache.Init = function () {
    ...
    function _destroy_git_proj(key, val) {
        ...
        inp.SSID = key
        var userProject = new BibleObjEmailUser()
...
var BibleObjEmailUser = function () {
...
BibleObjEmailUser.prototype._decipher_usr_by_key_stored_in_cuid = function (cuid, cipherusrs) {
...
BibleObjEmailUser.prototype.Proj_parse_usr_signOn = function (inp) {
    ...
    //if existance return existance 
    if(inp.email && inp.epass){
...
BibleObjEmailUser.prototype.Proj_parse_usr_signin = function (inp) {
    console.log("========Proj_parse_usr_signin")
    this.m_inp = inp
    if (!inp || !inp.out) {
        console.log("!inp || !inp.out")
...
BibleObjEmailUser.prototype.Proj_parse_usr_after_signed = function (inp) {
    this.m_inp = inp
    if (!inp || !inp.out) {
        return null
    }
...
BibleObjEmailUser.prototype.proj_get_usr_aux_ttl = function (inp) {
    var ttl = (inp.par.aux && inp.par.aux.cacheTTL) ? inp.par.aux.cacheTTL : null
    return ttl
}
BibleObjEmailUser.prototype.proj_get_usr_fr_cache_ssid = function (inp) {
...
BibleObjEmailUser.prototype.proj_update_cache_ssid_by_inp_aux = function (inp) {
...
BibleObjEmailUser.prototype.session_get_github_owner = function (docfile) {
...
BibleObjEmailUser.prototype.session_git_repodesc_load = function (docfile) {
    //jspfn: ../../../../bist/usrs/github.com/bsnp21/pub_test01/account/myoj/myNote_json.js
...
BibleObjEmailUser.prototype.Session_create = function () {
...
BibleObjEmailUser.prototype.Session_delete = function () {
...
module.exports = {
    BibleUti: BibleUti,
    NCache: NCache,
    BibleObjEmailUser: BibleObjEmailUser
}